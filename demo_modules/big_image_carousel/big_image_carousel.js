...
class BigImageCarouselSketch {
  ...
  preload() {
    ...
    debug('screen with y_index ' + this.y_index);
  ...
  setup() {
    ...
    debug('num tiles is ' + this.tiles.length);
    debug('sum_tile_width is ' + this.sum_tile_width);
...
class BigImageCarouselClient extends ModuleInterface.Client {
  ...
  willBeShownSoon(container, deadline) {
    debug('config in willBeShownSoon is ' + this.config);
