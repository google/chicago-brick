// http://jsfiddle.net/TDzVE/ - packed circles
// http://jsfiddle.net/MattCruikshank/Aq3z8/16/ - chaos theory
...
class ChaosClient extends ModuleInterface.Client {
  ...
  position(count) {
    var x = Math.cos(this.toRadians(360.0 * count / this.points)) * (this.surface.virtualRect.h / 2) + (this.surface.virtualRect.w / 2);
    var y = Math.sin(this.toRadians(360.0 * count / this.points)) * (this.surface.virtualRect.h / 2) + (this.surface.virtualRect.h / 2);
    return [x, y];
  }
