...
var StarsServer = function() {
  this.stars = [];
};
StarsServer.prototype = Object.create(ServerModuleInterface.prototype);
StarsServer.prototype.willBeShownSoon = function() {
...
StarsServer.prototype.tick = function(time, delta) {
...
var StarsClient = function(config) {};
StarsClient.prototype = Object.create(ClientModuleInterface.prototype);
StarsClient.prototype.finishFadeOut = function() {
  if (this.surface) {
    this.surface.destroy();
  } 
};
StarsClient.prototype.willBeShownSoon = function(container, deadline) {
  this.surface = new CanvasSurface(container, wallGeometry);
  this.canvas = this.surface.context;
};
StarsClient.prototype.draw = function(time, delta) {
  // Clear the screen.
