...
define(function(require) {
  ...
  class IdleState extends stateMachine.State {
    ...
    enter_() {}
    nextModule(module) {
      this.transition_(new PrepareState(null, module));
    }
  }
  ...
  class PrepareState extends stateMachine.State {
    ...
    enter_() {
      ...
      if (!this.module_.willBeShownSoon()) {
        ...
        this.transition_(new TransitionState(this.oldModule_, null));
        return;
      }
  ...
  class TransitionState extends stateMachine.State {
    ...
    enter_() {
      ...
      if (this.module_ && !this.module_.fadeIn(fadeDeadline)) {
        this.module_.dispose();
        this.module_ = null;
      }
