...
export class SharedState {
  constructor(name, interpolator, owner) {
    // For debugging purposes only.
    this.name_ = name;

    // A store of timestamp, value tuples. We store no more than the last 25
...
export function addSimpleInterpolator(interpolator) {
