...
var binarypack_1 = binarypack.pack;
var binarypack_2 = binarypack.unpack;
...
util.pack = binarypack_1;
util.unpack = binarypack_2;
// Binary stuff
util._dataCount = 1;
...
var reliable_1 = reliable.higherBandwidthSDP;
            ...
            try {
                ...
                if (!util.supports.sctp && this.connection.type === ConnectionType.Data) {
                    ...
                    if (dataConnection.reliable) {
                        offer.sdp = reliable_1(offer.sdp);
                    }
                }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!util.supports.sctp && this.connection.type === ConnectionType.Data) {
                    const dataConnection = this.connection;
                    if (dataConnection.reliable) {
                        answer.sdp = reliable_1(answer.sdp);
                    }
                }
                if (this.connection.options.sdpTransform && typeof this.connection.options.sdpTransform === 'function') {
